      ...
      <div className="full lg:w-[30%] flex justify-center lg:justify-end">
        <div className="w-[90%] sm:w-[60%] lg:w-full relative">
          <img
            ...
            alt={props.title}
          />
          <div className="lg:w-full p-5 rounded-sm bg-darkSecondary text-gray-200 shadow-md absolute bottom-10 lg:bottom-5 -right-8 sm:-right-20 lg:-right-10 left-8 sm:left-20 lg:left-10 font-light">
