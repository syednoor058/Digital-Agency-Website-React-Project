...
export default function WhyChooseUs() {
  return (
    <div className="py-10 lg:py-20 font-bodyFont text-darkSecondary bg-lightPrimary relative overflow-hidden">
      <div className="w-[60%] aspect-square rounded-[100%] bg-darkPrimary p-40 absolute -left-60 xl:-left-80 xl:-bottom-[400px] opacity-5 xl:opacity-10 z-[1] hidden xl:flex">
      ...
      <div className="flex flex-col gap-7 sm:gap-10 lg:gap-20 px-5 sm:px-7 lg:px-10 xl:px-20 relative z-[5]">
        ...
        <div className="flex flex-col xl:flex-row gap-5 sm:gap-7 lg:gap-10">
          <div className="w-full xl:w-[40%] flex flex-col gap-5 sm:gap-7 lg:gap-10 overflow-hidden">
            <div className="flex flex-col gap-2 leading-none text-darkPrimary font-titleFont uppercase">
          ...
          <div className="w-full xl:w-[60%] flex flex-col sm:flex-row gap-5 sm:gap-7 lg:gap-10 xl:pt-20">
            <div className="flex flex-col gap-5 sm:gap-7 lg:gap-10 sm:pt-16">
              ...
              />
              <div className="w-full h-[1px] bg-darkPrimary hidden sm:flex"></div>
              <WhyChooseUsCard
                icon={<FcSelfie />}
            ...
            <div className="w-[2px] h-auto bg-darkSecondary hidden sm:flex"></div>
